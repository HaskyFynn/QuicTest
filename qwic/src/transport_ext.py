...
# # Define a dictionary mapping QUIC transport parameter types to their names
...
# # Define the QUIC_Transport_Param class inheriting from Packet
# class QUIC_Transport_Param(Packet):
#     fields_desc = [
#         ByteEnumField("type", 0x00, _quic_transport_params),
#         FieldLenField("len", None, length_of="value", fmt="B"),
#         StrLenField("value", None, length_from=lambda pkt: pkt.len)
#     ]


# # Define the QUIC_Ext_Transport class inheriting from TLS_Ext_Unknown
# class QUIC_Ext_Transport(TLS_Ext_Unknown):
#     name = "TLS Extension - QUIC transport parameters (for ClientHello)"
#     fields_desc = [
#         ShortField("type", 0x39),
#         FieldLenField("len", None, length_of="parameters"),
#         PacketListField("parameters", [], QUIC_Transport_Param, length_from=lambda pkt: pkt.len)
#     ]

#     @classmethod
#     def initial(cls, scid):
#         """
#         Creates a pre-configured QUIC_Ext_Transport object with common parameters.

#         Args:
#             scid (bytes): The initial source connection ID.

#         Returns:
#             QUIC_Ext_Transport: The pre-configured QUIC transport parameters extension.
#         """

#         # Define the list of QUIC transport parameters
#         parameters = [
#             QUIC_Transport_Param(type=0x01, value=b'\x80\x00\x75\x30'),  # max_idle_timeout
...
#         # Create the QUIC_Ext_Transport object
